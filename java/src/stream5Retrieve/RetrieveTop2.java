...
public abstract class RetrieveTop2<N extends Node> {

    private static final Log log = new Log(RetrieveTop2.class);
    ...
    public void add(RetrieveTop2<N> other) {
    ...
    public void sharePool(RetrieveTop2 retriever) {
