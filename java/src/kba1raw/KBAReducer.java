 ...
 * @author jeroen
 */
public class KBAReducer extends Reducer<IntLongStringIntWritable, SentenceWritable, NullWritable, SentenceWritable> {

    public static final Log log = new Log(KBAReducer.class);
    int sequence = 0;
