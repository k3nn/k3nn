 ...
 * @author jeroen
 */
public class DomainReducer extends Reducer<IntWritable, Text, NullWritable, SnapshotWritable> {

    public static final Log log = new Log(DomainReducer.class);
    LogFile logfile;
    SnapshotWritable outvalue = new SnapshotWritable();
    Domain_IA_Israel domain = Domain_IA_Israel.instance;
    Date startdate;
    Date enddate;
