 ...
 * @author jeroen
 */
public class NavigateReducer extends Reducer<RandomWritable, SnapshotWritable, NullWritable, SnapshotWritable> {

    public static final Log log = new Log(NavigateReducer.class);
