...
import static kba9trec.RetrieveTop3.getTopics;
...
public class RetrieveJob {
    ...
    public static Job setup(String args[]) throws IOException {
        ...
        job.setMapOutputValueClass(RelClusterWritable.class);
    ...
    static class InputFormat extends ParamFileInputFormat<StreamClusterFile, Setting, StreamClusterWritable> {
    ...
    public static ArrayList<Setting> getParams() {
        ...
        for (double gainratio : new double[]{0.3, 0.35, 0.4, 0.45, 0.55, 0.6, 0.65, 0.7}) {
